...
from mpc_rl_collision_avoidance.external.stable_baselines.common.vec_env import VecEnv, sync_envs_normalization, DummyVecEnv
from mpc_rl_collision_avoidance.external.stable_baselines.common.evaluation import evaluate_policy
from mpc_rl_collision_avoidance.external.stable_baselines import logger

if typing.TYPE_CHECKING:
    from mpc_rl_collision_avoidance.stable_baselines.common.base_class import BaseRLModel  # pytype: disable=pyi-error
